          ...
          <div>
            <LayoutGroup>
              <h1 className="text-4xl font-bold tracking-tight text-balance text-gray-900 sm:text-6xl lg:text-7xl leading-tight">
                ...
                />{' '}
                Built for the Modern Student.add
              </h1>
            </LayoutGroup>

            <p className="mt-6 text-base font-medium text-pretty text-gray-600 sm:text-lg lg:text-xl leading-relaxed max-w-3xl mx-auto">
              Stop drowning in messy files, broken formatting, and endless walls of text. Bubbly handles the heavy lifting of document creation, secures your research, and gives you a professional mentor—anywhere you work.
            </p>
