...
const navigation = {
  solutions: [
    ...
    { name: 'Template Engine', href: '#features' },
    { name: 'Academic Mentor Mode', href: '#features' },
  ],
  support: [
      ...
      <div className="mx-auto max-w-7xl px-6 pt-16 pb-12 lg:px-8 lg:pt-20">
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          ...
          <div className="space-y-8">
            ...
            <p className="text-sm text-gray-400 leading-relaxed max-w-md">
              The AI Workspace Built for the Modern Student. Stop drowning in messy files, broken formatting, and endless walls of text. Unified academic intelligence everywhere you work.
            </p>
            ...
            <div className="pt-2">
              ...
              <form onSubmit={(e) => e.preventDefault()} className="flex max-w-md gap-x-2">
                <input
                  type="email"
                  required
                  placeholder="Enter your student email"
                  className="min-w-0 flex-auto rounded-lg bg-white/5 px-3.5 py-2 text-sm text-white placeholder-gray-500 border border-white/10 focus:outline-none focus:ring-2 focus:ring-indigo-500"
                />
                <MagneticButton strength={0.6} maxDistance={60}>
                  <button
                    type="submit"
                    className="flex-none rounded-lg border border-indigo-500/80 px-4 py-2 text-sm font-semibold text-white hover:bg-indigo-600 transition-colors cursor-pointer"
                  >
                    Subscribe
                  </button>
                </MagneticButton>
            ...
            <div className="md:grid md:grid-cols-2 md:gap-8">
              ...
              <div className="mt-10 md:mt-0">
                ...
                <div className="mt-6 bg-white/5 rounded-xl p-4 border border-white/10">
                  <div className="flex items-center gap-x-2 text-xs font-semibold text-emerald-400">
                  ...
                  <p className="mt-2 text-xs text-gray-400 leading-relaxed">
                    Your live AI engine and document vault are synced and ready whenever you are.
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="mt-16 border-t border-gray-800/80 pt-8 sm:flex sm:items-center sm:justify-between">
          <p className="text-xs text-gray-500 leading-5">
            &copy; {new Date().getFullYear()} Bubbly AI Inc. All rights reserved. Built for modern students worldwide.
          </p>
