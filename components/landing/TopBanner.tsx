...
export default function TopBanner() {
  ...
  return (
    <div className="relative isolate z-50 flex items-center gap-x-6 overflow-hidden bg-gray-900 px-6 py-2.5 after:pointer-events-none after:absolute after:inset-x-0 after:bottom-0 after:h-px after:bg-white/10 sm:px-3.5 sm:before:flex-1">
      <div
        aria-hidden="true"
      ...
      <div className="flex flex-1 justify-end">
        ...
        >
          ...
          <XMarkIcon aria-hidden="true" className="size-5 text-gray-100 hover:text-white" />
        </button>
      </div>
    </div>
  )
